...
texts = {
    ...
    rcmt: {
        ...
        en: 'A photo guide to Abrau-Durso. One day in Abrau.'
    },
    rcmds: {
        ...
        en: 'In the evening, Abrau absorbs all the magic and becomes an even more attractive and memorable place. To spend a wonderful evening at dinner and get a lot of positive emotions, tourists are invited to visit the famous places of Abrau'
    }
...
posts = {
    ...
    lgal: {
        ...
        <p>В заключительной части мультимедийного представления зрителей ожидает ренессанс – возрождение виноградной лозы. Несмотря на пройденные  трудности, сила винограда вновь открывает гармонию, вдохновение и радость творчества.</p> <h4>Экспозиция доступна к посещению ежедневно.</h4>
    `
    }, 
    ozbam: {
